<?php
/**
 * Contains Somoscuatro\Theme\Custom_Post_Types\Post_Types\Tech_Tools Class.
 *
...
/**
 * Tech Tools Custom Post Type Functionality.
 */
class Tech_Tools extends Custom_Post_Type {
	 ...
	 * @var string
	 */
	protected string $singular_name = 'Tech Tool';
	 ...
	 * @var string
	 */
	protected string $plural_name = 'Tech Tools';
