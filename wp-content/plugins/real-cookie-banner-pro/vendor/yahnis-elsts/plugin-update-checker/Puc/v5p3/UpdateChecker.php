...
if (!\class_exists(UpdateChecker::class, \false)) {
    ...
    abstract class UpdateChecker
    {
        ...
        {
            if (\class_exists('DevOwl\\RealCookieBanner\\Vendor\\Debug_Bar', \false) && \class_exists('DevOwl\\RealCookieBanner\\Vendor\\Debug_Bar_Panel', \false) && \file_exists(\dirname(__FILE__) . '/DebugBar')) {
