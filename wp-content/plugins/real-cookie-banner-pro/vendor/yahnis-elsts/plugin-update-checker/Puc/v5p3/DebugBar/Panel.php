...
namespace DevOwl\RealCookieBanner\Vendor\YahnisElsts\PluginUpdateChecker\v5p3\DebugBar;

use DevOwl\RealCookieBanner\Vendor\YahnisElsts\PluginUpdateChecker\v5p3\UpdateChecker;
if (!\class_exists(Panel::class, \false) && \class_exists('DevOwl\\RealCookieBanner\\Vendor\\Debug_Bar_Panel', \false)) {
    /** @internal */
    class Panel extends \DevOwl\RealCookieBanner\Vendor\Debug_Bar_Panel
    {
        /** @var UpdateChecker */
